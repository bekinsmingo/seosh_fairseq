...
@dataclass
class AudioTextPretrainingConfig(FairseqDataclass):
...
@register_task("data2vec_audio_text_pretraining", dataclass=AudioTextPretrainingConfig)
class AudioTextPretrainingTask(FairseqTask):
    """ """

    cfg: AudioTextPretrainingConfig

    @classmethod
    def setup_task(cls, cfg: AudioTextPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (AudioTextPretrainingConfig): configuration of this task
        """
